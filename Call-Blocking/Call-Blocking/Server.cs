...
namespace Call_Blocking
{
    static class Server
    {
        ...
        private const int LocalPort = 4578;
        private static SIPApp _app;
        private const String ServerURI = "callblocker@open-ims.test";
        ...
        private static bool callerIsBlacklisted(Message request)
        {
            return !request.First("From").ToString().ToLower().Contains("bob");
        }
