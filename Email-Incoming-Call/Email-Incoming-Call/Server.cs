...
namespace Email_Incoming_Call
{
    static class Server
    {
        ...
        private const int LocalPort = 7281;
        private static SIPApp _app;
        private const String ServerURI = "emailincoming@open-ims.test";
        ...
        private static void SendCallDetailEmail(Message request)
        {
            // Stub for sending Email
            DebugLog.Info("Email sending stub hit");
        }
